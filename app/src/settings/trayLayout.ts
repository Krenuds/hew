...
const KEYS = ['modelInfo', 'objectInfo', 'materials', 'components', 'tags', 'scenes', 'changes'] as const

/**  defaults: Object Info + Outliner + Scenes open, Materials + Components +
 * Tags + Changes collapsed. */
